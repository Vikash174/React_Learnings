...
const JsxHeading = (
  <>
    <h1 id="heading" className="firstHeading">
      This heading element is build using JSX
    </h1>
 ...
 * Function Componene - new
 *
 * */

//React function component - JavaScript return the any peice of JSX is a functional component in React

const SubHeadingComponent = () => <h2>This is a heading componenet</h2>;
const HeadingComponent = () => (
  <div id="container">
    <h1>This is a heading componenet</h1>
    <SubHeadingComponent />
  </div>
);
const root = ReactDOM.createRoot(document.getElementById('root'));
